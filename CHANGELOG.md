...
## [0.12.0](https://github.com/janiphoym/plunk/compare/v0.11.0...v0.12.0) (2026-05-16)


### Features

* Ability to change subscription status in workflows ([fadc19d](https://github.com/janiphoym/plunk/commit/fadc19d139084550eb442a8b8368edcd6075cad0))
* Ability to change workflow trigger ([eec37ec](https://github.com/janiphoym/plunk/commit/eec37ecb31c63888879a1933dba4fd0c6243018b))
* ability to create new campaigns based on templates or previous campaigns ([6b25bbe](https://github.com/janiphoym/plunk/commit/6b25bbe2f86e5dd6946ea38a9f34e9c7bdb5fb0f))
* Ability to disable signups and disable email verification for self-hosters ([9316564](https://github.com/janiphoym/plunk/commit/93165644af1ebcd7d5eb1900b13e5e38c1af0262))
* Ability to overwrite locale on contact level with locale key on data ([7615523](https://github.com/janiphoym/plunk/commit/76155232a3383e75e8c7b44a498454b07472852a))
* add 'notTriggeredWithin' operator to segment filters for enhanced event tracking ([0f00ca1](https://github.com/janiphoym/plunk/commit/0f00ca1b8c9bd95f2158af845218ef432ab0d498))
* add "olderThan" segment filter operator ([b5fa21a](https://github.com/janiphoym/plunk/commit/b5fa21a57cbf491e0438eb29fc9419063fa2aea7))
* Add accept/markdown to apps/landing ([df76be1](https://github.com/janiphoym/plunk/commit/df76be1b87de14769a219ae0e6c99711edf993a1))
* Add additional banner and information about security metrics ([bc8611a](https://github.com/janiphoym/plunk/commit/bc8611a66250eb7747e7acd6e882a740c0028ba1))
* Add additional checks for website, NS records and personal emails ([0a67a82](https://github.com/janiphoym/plunk/commit/0a67a8278f45d89b1abdf55be1cf251a470595cf))
* Add advanced DNS configuration ([7964563](https://github.com/janiphoym/plunk/commit/7964563b620868279f5fb6baab0d7499c41f51ed))
* Add billing for inbound ([3330d83](https://github.com/janiphoym/plunk/commit/3330d83d08904bc547740bfc9fdcbc5ff214d977))
* Add billing for inbound ([de7ed84](https://github.com/janiphoym/plunk/commit/de7ed84fcfddde16a9297c947048e9876712f6fa))
* Add bounce and complaint filter to activity feed ([c85df75](https://github.com/janiphoym/plunk/commit/c85df75d539f7e5500a9a109966b0e6d654d4022))
* Add bulk actions to contact overview ([726f667](https://github.com/janiphoym/plunk/commit/726f66762b890c73041139432524d6c85d6bd709))
* add className prop to EmptyState component for custom styling ([c278a0f](https://github.com/janiphoym/plunk/commit/c278a0fd944977d4ea3a0c5a4a43ff4cc0a13aa3))
* add configurable attachment limits for email service ([2eb4079](https://github.com/janiphoym/plunk/commit/2eb407993bd5fed3e74be73445185e517c18b994)), closes [#358](https://github.com/janiphoym/plunk/issues/358)
* Add cooldown to resend verification email ([457c829](https://github.com/janiphoym/plunk/commit/457c829b2d59debc41ac69f907f758dd5ded1c1a))
* Add dedicated received type ([f947ee6](https://github.com/janiphoym/plunk/commit/f947ee6f22371055801fa9cfc62e15df7851986c))
* add documentation link and redirect to WIKI_URI ([4c81d9e](https://github.com/janiphoym/plunk/commit/4c81d9ec04003550b140d884f37ebbf13137166d))
* Add email verification and password reset ([1a5607f](https://github.com/janiphoym/plunk/commit/1a5607f2780d5a4692492032dd0cd2e7521362d9))
* Add email verification endpoint at /v1/verify ([6a9f6aa](https://github.com/janiphoym/plunk/commit/6a9f6aa65a3219c5d4d6f33253cdcf145c3ff20b))
* Add email verification on signup ([fb02051](https://github.com/janiphoym/plunk/commit/fb02051538029d8a6b806ce69b25fb9e75622693))
* Add emailId field to webhook events for better correlation with send requests ([ae64c2d](https://github.com/janiphoym/plunk/commit/ae64c2dbb5b76f16b562641953f262d76ea0d8e8)), closes [#344](https://github.com/janiphoym/plunk/issues/344)
* add external link to edit email templates in SendEmailStepDialog and WorkflowBuilder ([4ba43dd](https://github.com/janiphoym/plunk/commit/4ba43dd3b64776413f813e091f527aa3e56bfc84))
* Add forwarding domains as verification check ([e732c76](https://github.com/janiphoym/plunk/commit/e732c76490e015b87a9165a98f1f1b5084552f84))
* Add headless template type ([fb5aa87](https://github.com/janiphoym/plunk/commit/fb5aa8796a8550be7a70fdd91616c9a41ed3047d))
* Add id as reserved field in templates, campaigns and workflows ([7386441](https://github.com/janiphoym/plunk/commit/7386441e6137ac9f059a3818895f1b1059e2d99d))
* Add improved html editor using CodeMirror ([672f1e6](https://github.com/janiphoym/plunk/commit/672f1e6657293860554be1f86167cf4f4403b0ff))
* Add inbound handling ([d050b55](https://github.com/janiphoym/plunk/commit/d050b55baaf46306be3fb6e5ad683205e158bd65))
* Add initial handling in webhook for inbound ([e01dc40](https://github.com/janiphoym/plunk/commit/e01dc4066c5e5eb5e0e69ef92f8a5bb7786e5a91))
* Add initial handling in webhook for inbound ([c286f49](https://github.com/janiphoym/plunk/commit/c286f490974d8dfe9c94695c63e6b48216b8052d))
* add Markdown cut link to footer and page for improved accessibility ([ccd516e](https://github.com/janiphoym/plunk/commit/ccd516e4e882921fb1a8a3e87c47710e51e35311))
* add middleware support for .md file rewrites ([0b3aa28](https://github.com/janiphoym/plunk/commit/0b3aa28101d50a734945ce19b924f9aa30631c64))
* add minimum thresholds for bounce and complaint rates ([d55dda3](https://github.com/janiphoym/plunk/commit/d55dda312718890231d1a428448e607792799c84))
* Add multi-branch workflow conditions (switch/case) ([92949b7](https://github.com/janiphoym/plunk/commit/92949b7596740b73d04c30e0e2bcc6305bbdf4a7))
* Add onboarding flow ([bd5a085](https://github.com/janiphoym/plunk/commit/bd5a0858021b9d74fae07cca5d2a0b8c10deabd7))
* Add platform emails for domain verification and expiration ([19554e6](https://github.com/janiphoym/plunk/commit/19554e6e8f94fbcf74006017454aa83a707617ea))
* Add plus address check to /v1/verify ([afc405e](https://github.com/janiphoym/plunk/commit/afc405ec028ac9d7333a7817c49f1232278fc28b))
* add project switching functionality to command palette ([5724ab9](https://github.com/janiphoym/plunk/commit/5724ab9536ea4e3bb4e916e963b1f39ba51bb7f3))
* Add project-scoped language for unsubscribe footer and contact-facing pages ([e1f8263](https://github.com/janiphoym/plunk/commit/e1f826357d1e8cff7bd3c2811698734f578836f5))
* add sanitize-html for improved email content sanitization ([735acff](https://github.com/janiphoym/plunk/commit/735acff45423cb537f7aa636b9a9d31830775f93))
* add search functionality to campaigns list with debounce effect ([d114950](https://github.com/janiphoym/plunk/commit/d11495061d907bcee699d56987784fa7ebe31bf6))
* Add security center and warning for exceeding bounce/complaint rates ([fbd3038](https://github.com/janiphoym/plunk/commit/fbd303801f9f1c260c5f8201bf218c9f277fe4d1))
* add segment membership operators and enhance segment filter functionality ([a3cc622](https://github.com/janiphoym/plunk/commit/a3cc62213f40f6a9341113b73b52852292fb9a10))
* Add support for custom email recipients in workflow steps ([78d3d22](https://github.com/janiphoym/plunk/commit/78d3d224af60cf5b58c6b18fdd0921320912fb09))
* add SwitchOffer component to promote switching from competitors for enhanced user engagement ([6195b39](https://github.com/janiphoym/plunk/commit/6195b39f3dbdd9fe783b79f9ae7f7942509a49a0))
* Add type to campaign ([d24259e](https://github.com/janiphoym/plunk/commit/d24259e8d202edd1b8c7771a63cc212c982b52e1))
* add updateActiveProject function for in-place project updates ([6f31fa2](https://github.com/janiphoym/plunk/commit/6f31fa2503b11e3a9a37d753086bbb74b42f7bc4))
* add workflow duplication functionality with API endpoint and UI button ([c6340a1](https://github.com/janiphoym/plunk/commit/c6340a1dc7385723d4ec30779340218935d814e6))
* Added platform emails for billing limits and disabled projects ([2485d2f](https://github.com/janiphoym/plunk/commit/2485d2ff1db652e87f8f1307c8ef770edd19bbd1))
* Allow to pick currency when starting subscription ([8a136dd](https://github.com/janiphoym/plunk/commit/8a136dde55fd1fae1f2a2e285019beb35fc75977))
* **api:** support inline images in emails using Content-ID ([9b15b93](https://github.com/janiphoym/plunk/commit/9b15b93b96344f811d869d103b3b6d344b531811))
* **api:** support inline images in emails using Content-ID ([c40394f](https://github.com/janiphoym/plunk/commit/c40394ffd6ef3dc844b9e475e20324cb4c5f0055))
* Automatically detect rate limit from AWS with ability to override in .env ([3225c50](https://github.com/janiphoym/plunk/commit/3225c5005be42f1443fdca0f8233193ce029c890))
* Block domain changes for disabled projects with appropriate error handling ([44c8657](https://github.com/janiphoym/plunk/commit/44c86572c275221b5068605c64958f43a1f96ff4))
* Disable projects on failed payment ([3343e89](https://github.com/janiphoym/plunk/commit/3343e891bdbcfee7d17d73a0d7fb181652e7c262))
* Email preview in contact and activity feed ([72dffe1](https://github.com/janiphoym/plunk/commit/72dffe12e53ff9d74ef43da2cf653d31e7a4df25))
* enhance campaign scheduling and audience settings UI for better clarity and usability ([7658a59](https://github.com/janiphoym/plunk/commit/7658a59b5df4e325ad9eca37356cad3cbb70e942))
* enhance contact addition with bulk email lookup and subscription options ([bb72911](https://github.com/janiphoym/plunk/commit/bb72911fa25e3a204095e74c07efbc261154ac30))
* enhance contact data handling by filtering empty strings and allowing null to delete fields ([1094651](https://github.com/janiphoym/plunk/commit/10946511b019ff76ce5f785a39cc0db4ea9ce820))
* Enhance ease of use of workflow editor ([c910d20](https://github.com/janiphoym/plunk/commit/c910d20bb71ff5de4abf95f3f96be9c435342cb4))
* Enhance email processing to include parsed HTML body content in inbound email records ([e339508](https://github.com/janiphoym/plunk/commit/e3395083db11fdb4b6cfdbace46518792ec132a3)), closes [#342](https://github.com/janiphoym/plunk/issues/342)
* Enhance login forms with last used authentication method ([f2ebce0](https://github.com/janiphoym/plunk/commit/f2ebce0ef2ac9c9c4e994cb754f67f6fa8a3f465))
* Enhance security metrics handling with new thresholds and improved messaging ([c0b2aba](https://github.com/janiphoym/plunk/commit/c0b2abaeca5656743e189f975ab82ff9b25b577b))
* **i18n:** Add Bulgarian translations ([663bc2b](https://github.com/janiphoym/plunk/commit/663bc2be8da69733d2bbc53c6b1bfcc36ff55cf8))
* **i18n:** add Chinese translations (zh-TW, zh-HK, zh-CN) ([33df563](https://github.com/janiphoym/plunk/commit/33df5632a3d4068e641687c8d404a6eef4aa4d0e))
* **i18n:** add Czech locale translations ([14c471e](https://github.com/janiphoym/plunk/commit/14c471e4cadbe1bbf90e53522134fad3d81ff107))
* **i18n:** add German translations and update supported languages ([a6bd2e7](https://github.com/janiphoym/plunk/commit/a6bd2e7dba261a858eab6ab1f782ddc9efb136a5))
* **i18n:** add Hindi translations for contact-facing pages ([ddc14ae](https://github.com/janiphoym/plunk/commit/ddc14ae8534eda2e1368f148e0434388008bb7b5)), closes [#246](https://github.com/janiphoym/plunk/issues/246)
* **i18n:** add Italian translation ([7b6872c](https://github.com/janiphoym/plunk/commit/7b6872c4b79b0fde4491f02851a2049c846c83d6))
* **i18n:** add Polish locale translations ([7a6df77](https://github.com/janiphoym/plunk/commit/7a6df7760bc73dfe80dcf2d37612e320f6de1d30))
* **i18n:** add Polish locale translations ([d2d779c](https://github.com/janiphoym/plunk/commit/d2d779c68f958a6ac0e77b7588e92a5c705a8fd4)), closes [#246](https://github.com/janiphoym/plunk/issues/246)
* **i18n:** Add Portuguese translations ([c2afb2d](https://github.com/janiphoym/plunk/commit/c2afb2dfab977ae74f3b694601a1f2d0353660a8))
* **i18n:** Add Spanish language ([9c69c7a](https://github.com/janiphoym/plunk/commit/9c69c7a36edd86fdc02b8d0d3e3f8d64ed8ecfa6))
* implement AWS SNS signature verification in SecurityService ([b79d416](https://github.com/janiphoym/plunk/commit/b79d4166671cc04cc1458d2c24af262af0e16c9e))
* implement bulk contact action selector for improved flexibility in bulk operations ([de6335e](https://github.com/janiphoym/plunk/commit/de6335e99999242f81e9eda9a20aeccab80a2de4))
* implement caching for recent activity count to optimize performance and reduce database load ([f22da4a](https://github.com/janiphoym/plunk/commit/f22da4add1e455678f380aba8c2fd02012ef6457))
* implement CommandPalette for enhanced navigation and recent pages tracking ([1c89ed0](https://github.com/janiphoym/plunk/commit/1c89ed083e49148967713e9a9c2f7f8833db07c4))
* implement early fraud warning handling in webhooks ([48425d1](https://github.com/janiphoym/plunk/commit/48425d1df160a3fd5edb4cbdcc9e6725628db319))
* implement meter event processing with queue for Stripe billing ([e048fc1](https://github.com/janiphoym/plunk/commit/e048fc157080b36f40fbfc4440db51367a2d374b))
* implement phishing detection using OpenRouter API with configurable sampling rate ([2da8b06](https://github.com/janiphoym/plunk/commit/2da8b065d08438aa2adea397d8ab2a560e996af6))
* Improved createdAt and updatedAt visualisation ([1019ba0](https://github.com/janiphoym/plunk/commit/1019ba0d82c7cb6a0d4cef5989841ccc28dae776))
* integrate DOMPurify for sanitizing HTML content ([bf12392](https://github.com/janiphoym/plunk/commit/bf12392b88fc92b0760333e1b568e3d6d1b6ed74))
* Integrate NuqsAdapter for improved state management and query handling ([0cf0a26](https://github.com/janiphoym/plunk/commit/0cf0a26a97e608f654ed3046c1a46d414557e3ee))
* make MAIL FROM subdomain configurable via MAIL_FROM_SUBDOMAIN env ([463301b](https://github.com/janiphoym/plunk/commit/463301b5db27b08b483db3c56a992ac62d6653b8))
* make MAIL FROM subdomain configurable via MAIL_FROM_SUBDOMAIN env var ([e0bf0f6](https://github.com/janiphoym/plunk/commit/e0bf0f628af2a155ca3bbc38ef5c2f4ecc0455e6))
* refactor template editing layout for improved usability and clarity ([aaf5ac6](https://github.com/janiphoym/plunk/commit/aaf5ac65307266a4d9deb02986b610757e929b49))
* Remove domain from AWS if no longer in use by other projects ([e6baace](https://github.com/janiphoym/plunk/commit/e6baace00d5f7a109e717b8a996bc2cda52cc9fa))
* Sort projects alphabetically in the dashboard and fix layout ([64bd094](https://github.com/janiphoym/plunk/commit/64bd094b47abbc4feaeb93d97915df57763b3907))
* Static segments ([4b51e38](https://github.com/janiphoym/plunk/commit/4b51e386e39ae38d6ea52eb87858de36fa45ab46))
* Update new project bounce thresholds for stricter email handling ([5e62f51](https://github.com/janiphoym/plunk/commit/5e62f517fc896849c270e795cd31a110b83707cc))


### Bug Fixes

* .dockerignore excludes nested build outputs (apps/*/dist, .next, .turbo, etc.) ([3fea06b](https://github.com/janiphoym/plunk/commit/3fea06ba2d7889fdd95b66e49872b6d7f5b3c335))
* .dockerignore excludes nested build outputs (apps/*/dist, .next, .turbo, etc.) ([1d1d407](https://github.com/janiphoym/plunk/commit/1d1d407a6fa336b587d656952b2a4cee14f8d61f))
* ability to clear reply-to and from name from templates and campaigns ([badb035](https://github.com/janiphoym/plunk/commit/badb035585561b276b6e82a363693918810c8214))
* Adapt SNS Webhook validation regex pattern to also support AWS eusc partition ([7b6540a](https://github.com/janiphoym/plunk/commit/7b6540a748a90c10f41b931450ac809e7ae23c01))
* Add additional checks for disabled projects ([863e784](https://github.com/janiphoym/plunk/commit/863e784e1c806118204acb3ba489322fe51498ad))
* Add additional checks for disabled projects ([780741e](https://github.com/janiphoym/plunk/commit/780741e37f7fec5b822b91c329ebe98428077ba0))
* add additional indexes on event model ([1cd89d1](https://github.com/janiphoym/plunk/commit/1cd89d137511ed4a8ae932a10f4f21487fbcee7c))
* Add additional verification in Oauth controllers ([53ecda9](https://github.com/janiphoym/plunk/commit/53ecda9f7a34111785ac3ea3af18cb33460a44af))
* add alt text to email badge image ([3b39d84](https://github.com/janiphoym/plunk/commit/3b39d847cd278317723b4b226434c26c49becebe))
* Add better validation for sender email ([e75e07f](https://github.com/janiphoym/plunk/commit/e75e07f73f5928ded281d2704b0fd06fedeb9077))
* add clear cache button on full-screen loader ([60804c1](https://github.com/janiphoym/plunk/commit/60804c12b0b4c4c3ef97e730e4857d41fa1fd021))
* Add in-memory cache for lower-confidence phishing checks ([208c809](https://github.com/janiphoym/plunk/commit/208c809a90d0721261e643523b338d05e23e2bf9))
* add new configuration options for phishing detection thresholds ([c0e0ad8](https://github.com/janiphoym/plunk/commit/c0e0ad8bc6bfdddea5193191156d18aad440c2b0))
* add project name and sender email parameters to phishing content check ([1637d54](https://github.com/janiphoym/plunk/commit/1637d54e1b132dd6864fb1c50d23a388c1c47bf5))
* add project name and sender email parameters to phishing content check ([15294a4](https://github.com/janiphoym/plunk/commit/15294a40d88289fa8fd876c9e7c201eb1e2ca956))
* Add styling for visual editor emails in preview ([5993b84](https://github.com/janiphoym/plunk/commit/5993b842a0f17d66644aaa3057602ae8f3daebc2))
* Add support for STATIC segment type in CampaignService ([7bd098b](https://github.com/janiphoym/plunk/commit/7bd098bdd01a8af0dd41ec515880289b1795e5af))
* added missing services:down script, added "win32" to supportedArchitectures for yarn package installation, added missing required WIKI_URI to .env.example of api ([ddbe523](https://github.com/janiphoym/plunk/commit/ddbe5237fe7012e197e3b398aebc8e2921a4328a))
* Align preview and actual email for templates and campaigns ([cc7fcdb](https://github.com/janiphoym/plunk/commit/cc7fcdb4ef31e9dfb4f7403aa93479b6df56719d))
* Allow changing audience type after creation of campaign ([85b9d7a](https://github.com/janiphoym/plunk/commit/85b9d7afe718c803be147475d5fbe13dafd677bf))
* Better highlight warnings in SecurityWarningBanner.tsx ([91eb0f3](https://github.com/janiphoym/plunk/commit/91eb0f3a699eb7a51e87addfa122107ce74b4a39))
* broken links to next-wiki.useplunk.com ([e3ea5fb](https://github.com/janiphoym/plunk/commit/e3ea5fb6dcea95b5028f140b77e54d5938497223))
* Catch unknown content-type headers ([a5c5754](https://github.com/janiphoym/plunk/commit/a5c575444ba698624b3932b4d6414c5ad9df282a))
* Center "Add Step" nodes below parent nodes and update positions on drag ([e4e334c](https://github.com/janiphoym/plunk/commit/e4e334c77a7ba41e5a60b69b9c64fa3bb72f1e74))
* Check email volume for 7-day window ([492beb0](https://github.com/janiphoym/plunk/commit/492beb095fd7be0cfd3de9761420d7ce1170d56f))
* Clear notification cache keys when changing billing limits ([e50c33a](https://github.com/janiphoym/plunk/commit/e50c33ae4b2d5144a1bfce72ae97d8ede0187d17))
* Connect branches smoothly to original node ([2c3e897](https://github.com/janiphoym/plunk/commit/2c3e8970cbc4ad2eb39fd505a4292345c6cae1c0))
* Consistency across buttons and labels ([c1bcd35](https://github.com/janiphoym/plunk/commit/c1bcd358cc611594d851414687c04bf7a03759a1))
* Consistency across cards ([517753c](https://github.com/janiphoym/plunk/commit/517753c420204510e06decec01db7749894a9265))
* Content negotiation for xml and txt ([c8190b9](https://github.com/janiphoym/plunk/commit/c8190b953f9f2e28e6cfa98e72d8dcfbba7e251b))
* contentId header injection fixed and separte unit test SESService added to verify MIME boundaries ([08e5c0d](https://github.com/janiphoym/plunk/commit/08e5c0d930f1db92b754a018ea08900f93032c64))
* Copy types build files ([49824af](https://github.com/janiphoym/plunk/commit/49824aff93c7ce09caa0cb57cfef68ae296f6626))
* correct cookie domain for .local TLD hostnames ([59aa784](https://github.com/janiphoym/plunk/commit/59aa7845bad69a1768bb88f83cfcea607c447538))
* Correctly reserve fields from being set on contact ([61cea95](https://github.com/janiphoym/plunk/commit/61cea95697ccb56c525002b08f76bf57da896837))
* Correctly set domain status on manual verify ([21af8fe](https://github.com/janiphoym/plunk/commit/21af8fe05e0450e8d826a3a01224511a337ca072))
* Correctly show recipient count during creation and edit ([d0191be](https://github.com/janiphoym/plunk/commit/d0191be31da8fc894269851a247746ce39a958b2))
* custom relative time to shorten strings for better UI fit ([5e4adb7](https://github.com/janiphoym/plunk/commit/5e4adb71ade38cf53e67776ae3524a381641fcfd))
* Date filtering not working properly for custom contact data ([97ab0a2](https://github.com/janiphoym/plunk/commit/97ab0a2c2c811ac1b8a2b9039ab835e837a3f3be))
* Dedicated token name for next version ([fc535a5](https://github.com/janiphoym/plunk/commit/fc535a558fab28045dae9ce978f483e58c72a24f))
* display email progress instead of scheduling progress for campaigns ([07f875c](https://github.com/janiphoym/plunk/commit/07f875c18c03a8d1766040bc40034c1023715fcd))
* Do not check verification if platform emails are not enabled ([9567144](https://github.com/janiphoym/plunk/commit/9567144390512173f7f615db71368c1cd26d9f4d))
* Do not unsubscribe existing contacts ([2c4d95e](https://github.com/janiphoym/plunk/commit/2c4d95e604cbed9189f7ee07c24b1f236fce7990))
* enhance campaign finalization process to handle pending emails and ensure accurate status updates ([2529c9b](https://github.com/janiphoym/plunk/commit/2529c9b4282b003a94013259119e98654ae22b46))
* Enhance CORS handling to allow requests with rejection logging ([718251c](https://github.com/janiphoym/plunk/commit/718251c67c876352a5dfca7592613e33f6713061))
* Enhance email activity filtering by adding date range checks ([ad0c17d](https://github.com/janiphoym/plunk/commit/ad0c17da566a26a296229c05d9b4e18cf7d401ad))
* Enhance email bounce notification with latest bounce details ([e639c72](https://github.com/janiphoym/plunk/commit/e639c72e8b940ba1da472d355f930359da7c868b))
* enhance email content parsing and logging for better debugging ([4587e9d](https://github.com/janiphoym/plunk/commit/4587e9d670fa3a27fbc1ca7669c8fc75d804e85e))
* Enhance email processing to support campaign types and improve unsubscribe logic ([9e2400c](https://github.com/janiphoym/plunk/commit/9e2400c6de6f13c498f02c489f956ebf89de36b0))
* Enhance email step configuration validation and recipient handling ([b50b5af](https://github.com/janiphoym/plunk/commit/b50b5af763d8a44b09c7022e1d9135bfca7907f6))
* Enhance email step configuration validation and recipient handling ([a99cde8](https://github.com/janiphoym/plunk/commit/a99cde88392450bf719112cb94cc1b9e7c7c1478))
* enhance project name validation to exclude invisible and decorative characters ([29883ff](https://github.com/janiphoym/plunk/commit/29883ffc7104d4beb13965bfa65ea609367ede69))
* enhance Quick Start card layout for improved responsiveness and usability ([649bbf6](https://github.com/janiphoym/plunk/commit/649bbf6d6b9db5139295a455c69425a5565d4323))
* Ensure template type is loaded before rendering Select ([8a38766](https://github.com/janiphoym/plunk/commit/8a38766c025afd5ef15fee4b7c5baea97a45ec48))
* handle undefined path in footer component for improved stability ([715961c](https://github.com/janiphoym/plunk/commit/715961c007e450731434e5f343acff0debd6a851))
* Harmonize rings and hover states ([f40cc86](https://github.com/janiphoym/plunk/commit/f40cc86cec661899fb862b56ce3e35bf70b33e54))
* Hide upsell banner if billing is not configured ([433e796](https://github.com/janiphoym/plunk/commit/433e796c041e8d65068084d5c7729c397956098e))
* Hint custom event names in combobox when no matches are found ([3214f6c](https://github.com/janiphoym/plunk/commit/3214f6c42d4ca6ab628e905ac69ed82648ccf47c))
* Implement content negotiation for markdown and html in middleware ([37ed1e4](https://github.com/janiphoym/plunk/commit/37ed1e49b78eb9339e7b62fd2fd5b60d451707d6))
* implement mergeContactData method for efficient contact data updates ([a27d564](https://github.com/janiphoym/plunk/commit/a27d564e1af6e5cf72c9ef405650f2475bfd0c86))
* Implement merging for activity updates to preserve component state ([0d4b694](https://github.com/janiphoym/plunk/commit/0d4b694208fd8e516e1f50f7384d1ac5bd6561e0))
* Implement SSRF protection in webhook handling with safeFetch method ([2c5a715](https://github.com/janiphoym/plunk/commit/2c5a71518da358927bd5e41035b85fd278790b47))
* Import no longer case-sensitive about email column ([451dd03](https://github.com/janiphoym/plunk/commit/451dd0327f4866fd27343407a84a6c979cfcd70d))
* Improve bounce handling logic to differentiate between permanent and transient bounces ([7df43d8](https://github.com/janiphoym/plunk/commit/7df43d8553eca93b601915ea4deaf59233e848c7))
* Improve email verification logic by prioritizing MX record checks and clarifying domain existence validation ([26800a8](https://github.com/janiphoym/plunk/commit/26800a85538fc90aa05fc43b1cc33cef95d8fb32))
* improve iframe height adjustment logic in EmailEditor component ([9e4aa94](https://github.com/janiphoym/plunk/commit/9e4aa9443b53ef38a3af1b269f4a949dd57e758f))
* improve layout and accessibility of workflow header and buttons ([ab3edd7](https://github.com/janiphoym/plunk/commit/ab3edd7dc9030eeb770ffd64087476adf10d2d06))
* Increase z-index of color picker ([769e374](https://github.com/janiphoym/plunk/commit/769e3748a0bbbcafdb1f79c9aea22d282e39b513))
* log message for projects passing phishing checks ([8628754](https://github.com/janiphoym/plunk/commit/862875428d21de03643e8e51126cc59abef95ccb))
* Migrate over to new pagination format in dashboard ([8790c45](https://github.com/janiphoym/plunk/commit/8790c45edc1374f9649b8438563fc8844a645367))
* Move react and react-dom to dependencies instead of peerDependency for API ([a555a12](https://github.com/janiphoym/plunk/commit/a555a127366f753130c765f9eb4700dc44a8cb7c))
* Move react and react-dom to dependencies instead of peerDependency for API ([f37bfcc](https://github.com/janiphoym/plunk/commit/f37bfccbc22a0c2672971ff0e174f49f31301876))
* normalize field references and handle undefined values in JSON ([b9d692c](https://github.com/janiphoym/plunk/commit/b9d692cf5b491ab22a40ec69e77ff7bdc62eec63))
* Only check free tier limits if billing is enabled ([1713b23](https://github.com/janiphoym/plunk/commit/1713b2398d5c238058639ac5a0d5cef916a7a1e8))
* Only fetch project members if project Id is defined ([5a0a41c](https://github.com/janiphoym/plunk/commit/5a0a41c6bbbb9bd4eefd5ed62e02c0a7c00c1022))
* only mark releases as latest ([9d8b4a5](https://github.com/janiphoym/plunk/commit/9d8b4a59fbd42420bb595d2a44df93a29214121a))
* Overflow of inputs in email editor ([3336fa1](https://github.com/janiphoym/plunk/commit/3336fa1e38a29d9c1f69c62259662b1ff2ba6e61))
* pass DISABLE_SIGNUPS and EMAIL_RATE_LIMIT_PER_SECOND through compose; trim .env.self-host.example ([8a26d60](https://github.com/janiphoym/plunk/commit/8a26d605b4aa5fdea0e02a17159c1cae478a7e47))
* pass missing env variables from .env.self-host.example to plunk service ([f178c59](https://github.com/janiphoym/plunk/commit/f178c59b5bc461f9ba57dc6f0bac9617feaab4a3))
* Pass through email verification if auth type is apiKey ([d7b5d3f](https://github.com/janiphoym/plunk/commit/d7b5d3f60ed1af6ca9bf8e2a659204a01ca3acb0))
* Persistence of subscription state for existing contacts ([007a908](https://github.com/janiphoym/plunk/commit/007a908e833cdd1b229f485c34c17c6510a55f9c))
* Prevent manual tracking of internal events that are automatically tracked ([f34052e](https://github.com/janiphoym/plunk/commit/f34052ed73cd78db4e4bf39cab8740ce0b78e93c))
* prevent scheduling of campaign if billing limit reached ([a3bbb1e](https://github.com/janiphoym/plunk/commit/a3bbb1ed64ba461cb2f7170c1929f68f22b5bb4d))
* Prevent switching if nodes are attached to multi-branch ([c32b54f](https://github.com/janiphoym/plunk/commit/c32b54f588db79a501db456e6075a337dee8ed26))
* prevent unnecessary state updates in search input effect ([98f1e80](https://github.com/janiphoym/plunk/commit/98f1e80fca8253c125ba24c4d84c5be86841e1fa))
* Properly tag events in SegmentFilterBuilder.tsx ([8f725c7](https://github.com/janiphoym/plunk/commit/8f725c7c84749eca5647fdbd19d41260f6998d6e))
* reconcile totalRecipients in CampaignService to prevent stuck campaigns ([4322de9](https://github.com/janiphoym/plunk/commit/4322de929a84279370bedcbb4f6b7dcd81145aea)), closes [#348](https://github.com/janiphoym/plunk/issues/348)
* Redirect verification link to dashboard instead of landing ([35f5275](https://github.com/janiphoym/plunk/commit/35f5275d889b167e0fe75246b29a4ffa632bad46))
* Reentry into segment not working after exit ([4dce71a](https://github.com/janiphoym/plunk/commit/4dce71a1fe22774391bf0d0e87f1564c3b93b496))
* Refactor CORS handling to allow unrestricted access for public API endpoints ([940c893](https://github.com/janiphoym/plunk/commit/940c8938f163879da5be205bcc8bb82ecd69279a))
* Refactor date filtering logic for pagination in ActivityFeed and ActivityService ([52cb2b6](https://github.com/janiphoym/plunk/commit/52cb2b6c77bc3912b356887bdd48e9c8b9b1728a))
* Refactor Redis keys to prevent multiple messages on concurrent requests ([4db1ccc](https://github.com/janiphoym/plunk/commit/4db1ccc3fc59edb0187d8e2223f45bb0bce6deb5))
* Remove 'Optional' label from MAIL FROM Domain and Inbound Email headings ([f9b1354](https://github.com/janiphoym/plunk/commit/f9b135446040de099484db66139560f43bbf027e))
* removed "any" data type from SESService.test.ts ([3a42012](https://github.com/janiphoym/plunk/commit/3a42012ac73592a2d2c167fe98a02f5d7614810f))
* replace font loading method with utility function for improved performance ([ba23a1c](https://github.com/janiphoym/plunk/commit/ba23a1c6fa70ca6fa0343391fa8d642155ad45c2))
* replace Select/datalist with styled Combobox for event name inputs ([3e3117e](https://github.com/janiphoym/plunk/commit/3e3117e4a7fbb5f2b029de0bd2ad837928675878))
* **ses:** emit List-Unsubscribe inside the header section, not the body ([11c428d](https://github.com/janiphoym/plunk/commit/11c428d4ffe7c8aa87aac4d24148aaa95e01507a))
* Set auth type before disable check ([862babb](https://github.com/janiphoym/plunk/commit/862babb8f5ab47599ce6a841fc988fafa1ec0bbe))
* show correct default value for placeholder ([04275e3](https://github.com/janiphoym/plunk/commit/04275e3cf59f902d50acb84e756f1c7425171726))
* standardize step type labels and update visual styles in workflow components ([bdc9b30](https://github.com/janiphoym/plunk/commit/bdc9b30ef29396870aa42515b8e688485a4673e8))
* Support any locale on creation ([ec1f4c9](https://github.com/janiphoym/plunk/commit/ec1f4c9374e06e3defed3c728be603c10e4e7baa))
* Sync display name in TemplateSearchPicker when initialName changes ([3649392](https://github.com/janiphoym/plunk/commit/3649392b475271198cd61295091e8acf708efa25))
* Sync display name in TemplateSearchPicker when initialName changes ([cbde3cc](https://github.com/janiphoym/plunk/commit/cbde3cce3fcee382dae04e79a9480e67ad896725))
* **test:** consolidate SES MIME boundary tests into EmailService.test.ts ([64ba19e](https://github.com/janiphoym/plunk/commit/64ba19e589ed7432f4f79f0315a7ca745cabed22))
* turn warning into success log ([b7eb254](https://github.com/janiphoym/plunk/commit/b7eb2549d433552f32783b6fb8c192f5afb48ecd))
* Unauthenticated users are redirected to login on subscribe/unsubscribe/manage pages ([11ef47b](https://github.com/janiphoym/plunk/commit/11ef47b576ec39209f2b9726c1027d06f8bbc03a))
* update activity item colors and backgrounds for improved visual distinction ([e43f70d](https://github.com/janiphoym/plunk/commit/e43f70d8a135b048d4e9ed013ffa25f1b2f89687))
* Update contact subscription logic for upsert operations ([a928666](https://github.com/janiphoym/plunk/commit/a928666dfcdc65c90602051c79b3c008282674aa))
* Update language validation regex to support locale variants ([7834b9e](https://github.com/janiphoym/plunk/commit/7834b9e7ef615ba029a1a091b0c37c8f40eb543c))
* update middleware matcher to exclude webmanifest files ([cbb3bff](https://github.com/janiphoym/plunk/commit/cbb3bffcf4f789e9c36912c9b0ce0ba9f6a1d4dd))
* update not found handling in GET route to return 404 response ([7615b62](https://github.com/janiphoym/plunk/commit/7615b62945aa1939bf6a5b3638c232509090de60))
* update old references to next.useplunk.com ([44987d2](https://github.com/janiphoym/plunk/commit/44987d2b5e8028c6f8f26c39e9dec386e1ccf6e1))
* update phishing confidence threshold to 95% ([bb78c86](https://github.com/janiphoym/plunk/commit/bb78c86c400b60fb0e84c7872e20ad6f7c43c199))
* update project disabled messages for clarity and consistency ([d7eb85f](https://github.com/janiphoym/plunk/commit/d7eb85ffdd99177c5e27104779281f5a08fe36a7))
* update project icon colors for improved visibility and consistency ([5f741c6](https://github.com/janiphoym/plunk/commit/5f741c66c7f0c9c25c45b26917ff68529d15f958))
* Update recipient count on create/update of campaign ([ff5c79c](https://github.com/janiphoym/plunk/commit/ff5c79cfcf0ac6b351af20345ec639110f206f4b))
* update response format for phishing analysis and improve JSON parsing comment ([91d0d2d](https://github.com/janiphoym/plunk/commit/91d0d2d297cb38fe0dfdfd7f73df355e2f51096a))
* update segment filter logic to retain value and unit, enhance activity name mapping ([d1f357c](https://github.com/janiphoym/plunk/commit/d1f357c300c7798d5c8d521e1219e39e7da821dd))
* update segment filter logic to retain value and unit, enhance activity name mapping ([a126563](https://github.com/janiphoym/plunk/commit/a1265635420e66b7cdef02a7136fdf9c3aec4418))
* Update sentCount on campaign sent for correct overview stats ([ee00eb3](https://github.com/janiphoym/plunk/commit/ee00eb34811270473d1f79729853eaada883a477))
* Update template fetching to use Template type and simplify body access ([b6c5471](https://github.com/janiphoym/plunk/commit/b6c5471d272e8ba835282691946a418385896c98))
* Update templates data fetching to use PaginatedResponse type ([fa22b82](https://github.com/janiphoym/plunk/commit/fa22b8220a909e7234948aeeb2a6734ae51aeec9))
* update TemplateSearchPicker to maintain selected template name on change ([2ea1802](https://github.com/janiphoym/plunk/commit/2ea1802290a4378d68e3878a44e502ea8541b301))
* Update URL replacement logic to handle runtime paths and add warnings for missing files ([c07816c](https://github.com/janiphoym/plunk/commit/c07816c2a1b029d83400128f4720263e975214ad))
* Variable substitution in transactional emails ([8c03042](https://github.com/janiphoym/plunk/commit/8c0304273c2bd1a64718ec56838632aa63447ef8))
* Verify if sending without tracking is possible in SESService ([68f9979](https://github.com/janiphoym/plunk/commit/68f99798f8c5944c18b438329b961fdec955ecef))
* Verify SNS URL before sending fetch request ([b8f1ad9](https://github.com/janiphoym/plunk/commit/b8f1ad9ab53c78f8ef063fdc125f397c8bfc7652))
* visual editor preview ([4451e92](https://github.com/janiphoym/plunk/commit/4451e921caff45dab126006ba103d91816bed696))


### Code Refactoring

* convert forwardRef components to function components for consistency ([361ec0b](https://github.com/janiphoym/plunk/commit/361ec0b1eb17647696656c6a6d4cddd5b9348b45))
* implement step dialog components for workflow editing ([ed9027b](https://github.com/janiphoym/plunk/commit/ed9027b4ef9c37e91c69ed5a90d5b74c08c7a054))
* remove unnecessary logging for segment processing ([42ceb6e](https://github.com/janiphoym/plunk/commit/42ceb6edc03ebc6f14c6d399e859914ac09f1ab6))
* remove unused .png files ([2d05c3f](https://github.com/janiphoym/plunk/commit/2d05c3fbc1ded87880a307943bb93106b18cd406))


### Documentation

* Add content negotiation to apps/wiki ([545d733](https://github.com/janiphoym/plunk/commit/545d7337948f41f006f9cb0270b4bfff2b08ed2c))
* Add inbound to docs ([6c4cc29](https://github.com/janiphoym/plunk/commit/6c4cc295b88db6da8d9edcf23064a3fc8e9f5c36))
* Add locale overwrite to project documentation ([1fc1e23](https://github.com/janiphoym/plunk/commit/1fc1e23fce69a870ccf95faf2fff644733de7145))
* Add more details about personalisation ([940a4d2](https://github.com/janiphoym/plunk/commit/940a4d225b86ba5af5377851ab758a43b3aa71ff))
* Add plus address check to /v1/verify ([0d54b1a](https://github.com/janiphoym/plunk/commit/0d54b1a631415a15e504ff5bd4573ddb12cc421a))
* Add receiving emails functionality and update DNS records documentation ([b426986](https://github.com/janiphoym/plunk/commit/b42698616a3f7bb079a092375ac886f2a9d7405d))
* add webhooks documentation for real-time event handling ([5bce1d7](https://github.com/janiphoym/plunk/commit/5bce1d74fffb927bcbb2c7df624fde089101efc8))
* dynamic link to Docker Compose for self-hosting ([90f8170](https://github.com/janiphoym/plunk/commit/90f8170efbad0cec981a24e7831840aac65d8d70))
* expand documentation with new sections on importing contacts, unsubscribe pages, and API key management ([4ddafdc](https://github.com/janiphoym/plunk/commit/4ddafdc0419389818de7e45eb4a0c82c2e9382eb))
* Fix broken links on api overview page ([dc2ce02](https://github.com/janiphoym/plunk/commit/dc2ce02d1a4e4d1641728b720ca856cedba719a7))
* Improve docs with core-concept and guides ([2ddfcec](https://github.com/janiphoym/plunk/commit/2ddfceca3606b0d4d832f83fce14c7277b5eaa35))
* Improve self-hosting env variable documentation ([f0ef346](https://github.com/janiphoym/plunk/commit/f0ef34646e7593f07a780141e14d6d2b735c1101))
* Improve webhook documentation ([f6a32ce](https://github.com/janiphoym/plunk/commit/f6a32ce610559050c1ca9978607bd57ac51e906f))
* Static segments ([e8a247f](https://github.com/janiphoym/plunk/commit/e8a247fe12b79ae8a25a74485179e93081fe2002))
* Update AWS setup docs ([f7ac25f](https://github.com/janiphoym/plunk/commit/f7ac25f91f4e1dcce301fb325801a67f2a9dee07))
* update contacts documentation to include subscription state and email delivery rules ([b4404f6](https://github.com/janiphoym/plunk/commit/b4404f698ec28a59f32d728c15c59c8b7765d377))
* Update openapi.json to match actual API outputs ([dc9b88d](https://github.com/janiphoym/plunk/commit/dc9b88dedb75535814239b4bc73f62375570998b))
* update README to clarify self-hosted alternative and add inbound emails feature ([80ef65e](https://github.com/janiphoym/plunk/commit/80ef65e04b8c362f05ae5b7d5710b398a150cce5))
